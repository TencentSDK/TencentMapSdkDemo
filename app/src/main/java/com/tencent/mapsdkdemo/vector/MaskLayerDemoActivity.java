 ...
 */
@SuppressLint("NewApi")
public class MaskLayerDemoActivity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mask_layer_demo);

        findViewById(R.id.add_mask).setOnClickListener(this);
        findViewById(R.id.remove_mask).setOnClickListener(this);
...
//                removeMaskLayer();
    ...
    private void addMaskLayer() {
        MaskLayerOptions opts = new MaskLayerOptions().color(0xffff0000).animationDuration(1000).zIndex(0);
        mMaskLayer = mMap.addMaskLayer(opts);
        mPolyline.setAboveMaskLayer(false);
    }

    private void removeMaskLayer() {
//        mMaskLayer.remove(2000);
        MaskLayerOptions opts = new MaskLayerOptions().color(0x1000ff00).animationDuration(1000);
        mMaskLayer = mMap.addMaskLayer(opts);
        mPolyline.setAboveMaskLayer(true);
    }
    ...
    private void setupMap() {
        ...
        mMap.setCompassExtraPadding(50, 100);
        addPolyline();
        addMarkers();
        addBubbles();
...
//        options.aboveMaskLayer(false);
    ...
    private void addStartMarker() {
        ...
        MarkerOptions options = new MarkerOptions()
                ...
                .infoWindowEnable(false).position(position).title("起点：北京市海淀区颐和园路66号").zIndex(5);
